...
router.post("/",async function (req, res) { 
    ...
    var query7= `INSERT INTO BUY_INFO(BUY_ORDER_ID,SUPPLIER_ID,PRODUCT_ID,CATEGORY_ID,BUY_QUANTITY,SUPPLY_DATE) VALUES(${buy_order_id},'${req.session.USERNAME}','${product_idd}','${category_idd}',${quantityy},SYSDATE)`;
